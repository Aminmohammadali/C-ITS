...
* **Key Issuer.py** : Takes the master secret keys and public keys generated by key\_generator.py, then computes each vehicle’s credential values A\_i and x\_i. These values are then delivered securely to each vehicle.
...
Verifier CBD code: python3 /home/mmobarak/Downloads/verifier\_final.py --host 0.0.0.0  --port 5000   --disable-sybil



Verifier CBD code for sybil attack check: python3 /home/mmobarak/Downloads/verifier\_final.py --host 0.0.0.0  --port 5000
